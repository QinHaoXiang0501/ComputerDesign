 ...
 * {@link MoveResult} and never mutates the player; the {@link Game} applies it.
 * The End-resolution policy is delegated to a {@link WinningStrategy}.
 */
public final class Board {
    ...
    public int homeOf(PlayerColor colour) { return configuration.homeOf(colour); }
    ...
    /**
     * Move a player backward {@code steps} squares from the End (the exact-landing
     * bounce-back): first back down the tail, then anticlockwise around the main
     * board if necessary.
     */
